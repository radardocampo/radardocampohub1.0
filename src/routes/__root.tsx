  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="stat text-5xl text-subtle">404</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Radar do Campo Hub" },
      {
        name: "description",
        content:
          "Painel de gestão de conteúdo digital: métricas, financeiro, rotina e banco de ideias.",
      },
      { property: "og:title", content: "Radar do Campo Hub" },
      {
        property: "og:description",
        content: "Painel de gestão de conteúdo digital do Radar do Campo.",
      },
